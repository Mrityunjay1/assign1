...
export default function Footer() {
    return (
        <Box bgColor="black"
            ...
            <Heading align="center" color="white" fontSize="80" pt="104" fontFamily="Circular Std Book" fontWeight="700">Ready to launch?</Heading>
            ...
            <Grid templateColumns="repeat(5, 1fr)" gap={6} mt="20" align="left" ml="40" fontFamily="Circular Std Book">
                <Box w="100%" h="10" >
